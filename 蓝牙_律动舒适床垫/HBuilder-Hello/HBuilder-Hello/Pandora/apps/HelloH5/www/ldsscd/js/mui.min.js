 ...
 * 获取设备宽度
 */
COM.getDeviceWidth = function(){
	return (window.plus && plus.screen.resolutionWidth) || window.innerWidth;
}
/**
 * 获取设备高度
 */
COM.getDeviceHeight = function(){
	return (window.plus && plus.screen.resolutionHeight) || window.innerHeight;
}
...
COM.ajax = function(obj) {
	...
	if(!url.startsWith('http')) {
		url = URL_DATA.https + url; //没有网址前缀 加上前缀
	}
 ...
 * 检测更新
 */
COM.checkUpdate = function(callBack) {
	var obj = {
		url: URL_DATA.appUpdate,
		type: "GET",
		sign: false,
		async: false,
		data: {
